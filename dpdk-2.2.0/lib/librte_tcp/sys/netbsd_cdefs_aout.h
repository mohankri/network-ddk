...
#ifndef NETBSD_SYS_CDEFS_AOUT_H
#define	NETBSD_SYS_CDEFS_AOUT_H

#include <netbsd_features.h>
...
#define	__link_set_make_entry(set, sym, type)				\
	static void const * const					\
	    __link_set_##set##_sym_##sym = &sym;		\
	__asm(".stabs \"__link_set_" #set "\", " #type ", 0, 0, " #sym)
#else
#define	__link_set_make_entry(set, sym, type)				\
